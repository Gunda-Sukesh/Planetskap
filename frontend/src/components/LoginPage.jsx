...
const LoginPage = () => {
    ...
    return (
        <main className="min-h-screen w-full overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative">
            {/* Rest of your existing JSX remains exactly the same until the form */}
            <div className="relative min-h-screen flex items-center justify-center p-4">
                {/* Background Effects - Added more 3D Shapes */}
                ...
                <div className="relative w-full max-w-md">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-white/70">Welcome back to your event platform</p>
                    </div>
                        ...
                        <form onSubmit={handleSubmit} className="relative space-y-6">
                                ...
                                <label className="flex items-center gap-2 cursor-pointer group/check">
                                    <input
                                        ...
                                        className="w-4 h-4 rounded border-white/20 bg-white/5 text-purple-600 
                                                 ...
                                                 focus:ring-offset-0 focus:ring-1 focus:ring-purple-500/20"
                                    />
                                    <span className="text-white/70 group-hover/check:text-white/90 transition-colors duration-300">
                                        Remember me
                                    </span>
                                </label>
                                <a
                            ...
                            >
                                <span className="flex items-center justify-center gap-2">
                                    <span>Sign In</span>
                                    <LogIn size={18} className="transition-transform duration-300 group-hover/btn:translate-x-1" />
                                </span>
                            </button>
                            ...
                            <div className="text-center">
                                ...
                                <a
                                    href="/signup"
                                    className="text-white/90 transition-transform duration-300 transform hover:scale-105 hover:text-purple-300"
                                >
                                    Sign up
                                </a>
                            </div>
